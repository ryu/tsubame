...
class FeedMarkAsReadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "create syncs read state to duplicates in other feeds" do
    ...
    post feed_mark_as_read_path(feeds(:ruby_blog)), headers: { "Accept" => "text/vnd.turbo-stream.html" }
  ...
  test "create marks all entries as read" do
    ...
    post feed_mark_as_read_path(feed), headers: { "Accept" => "text/vnd.turbo-stream.html" }
    assert_response :success
