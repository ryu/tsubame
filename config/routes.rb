Rails.application.routes.draw do
  ...
  resources :magic_links, only: :show, param: :token do
    resource :consumption, only: :create, controller: "magic_link_consumptions"
  end
  ...
  resource :pinned_entry_open, only: :destroy
